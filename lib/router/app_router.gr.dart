...
abstract class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    ReactionSearchExcludeRoute.name: (routeData) {
      final args = routeData.argsAs<ReactionSearchExcludeRouteArgs>();
      return AutoRoutePage<dynamic>(
        routeData: routeData,
        child: ReactionSearchExcludePage(
          key: args.key,
          account: args.account,
        ),
      );
...
/// generated route for
/// [ReactionSearchExcludePage]
class ReactionSearchExcludeRoute
    extends PageRouteInfo<ReactionSearchExcludeRouteArgs> {
  ReactionSearchExcludeRoute({
    Key? key,
    required Account account,
    List<PageRouteInfo>? children,
  }) : super(
          ReactionSearchExcludeRoute.name,
          args: ReactionSearchExcludeRouteArgs(
            key: key,
            account: account,
          ),
          initialChildren: children,
  ...
  static const String name = 'ReactionSearchExcludeRoute';

  static const PageInfo<ReactionSearchExcludeRouteArgs> page =
      PageInfo<ReactionSearchExcludeRouteArgs>(name);
}

class ReactionSearchExcludeRouteArgs {
  const ReactionSearchExcludeRouteArgs({
    this.key,
    required this.account,
  });
  ...
  @override
  String toString() {
    return 'ReactionSearchExcludeRouteArgs{key: $key, account: $account}';
  }
}
