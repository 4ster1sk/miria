...
$PhotoEditCopyWith<PhotoEdit> get copyWith => _$PhotoEditCopyWithImpl<PhotoEdit>(this as PhotoEdit, _$identity);
...
/// @nodoc
class _$PhotoEditCopyWithImpl<$Res>
...
as bool,colorFilterPreviewImages: null == colorFilterPreviewImages ? _self.colorFilterPreviewImages : colorFilterPreviewImages // ignore: cast_nullable_to_non_nullable
as List<ColorFilterPreview>,adaptivePresets: null == adaptivePresets ? _self.adaptivePresets : adaptivePresets // ignore: cast_nullable_to_non_nullable
as List<String>,isInitialized: null == isInitialized ? _self.isInitialized : isInitialized // ignore: cast_nullable_to_non_nullable
as bool,initialImage: freezed == initialImage ? _self.initialImage : initialImage // ignore: cast_nullable_to_non_nullable
as Uint8List?,editedImage: freezed == editedImage ? _self.editedImage : editedImage // ignore: cast_nullable_to_non_nullable
as Uint8List?,cropOffset: null == cropOffset ? _self.cropOffset : cropOffset // ignore: cast_nullable_to_non_nullable
as Offset,cropSize: null == cropSize ? _self.cropSize : cropSize // ignore: cast_nullable_to_non_nullable
as Size,defaultSize: null == defaultSize ? _self.defaultSize : defaultSize // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey() final  bool colorFilterMode;
 final  List<ColorFilterPreview> _colorFilterPreviewImages;
@override@JsonKey() List<ColorFilterPreview> get colorFilterPreviewImages {
  if (_colorFilterPreviewImages is EqualUnmodifiableListView) return _colorFilterPreviewImages;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_colorFilterPreviewImages);
}

 final  List<String> _adaptivePresets;
@override@JsonKey() List<String> get adaptivePresets {
...
@override final  Uint8List? initialImage;
@override final  Uint8List? editedImage;
@override@JsonKey() final  Offset cropOffset;
@override@JsonKey() final  Size cropSize;
@override@JsonKey() final  Size defaultSize;
@override@JsonKey() final  Size actualSize;
@override@JsonKey() final  int angle;
 final  List<EditedEmojiData> _emojis;
@override@JsonKey() List<EditedEmojiData> get emojis {
...
@pragma('vm:prefer-inline')
_$PhotoEditCopyWith<_PhotoEdit> get copyWith => __$PhotoEditCopyWithImpl<_PhotoEdit>(this, _$identity);
...
/// @nodoc
abstract mixin class _$PhotoEditCopyWith<$Res> implements $PhotoEditCopyWith<$Res> {
...
/// @nodoc
class __$PhotoEditCopyWithImpl<$Res>
    implements _$PhotoEditCopyWith<$Res> {
...
clipMode: null == clipMode ? _self.clipMode : clipMode // ignore: cast_nullable_to_non_nullable
as bool,colorFilterMode: null == colorFilterMode ? _self.colorFilterMode : colorFilterMode // ignore: cast_nullable_to_non_nullable
as bool,colorFilterPreviewImages: null == colorFilterPreviewImages ? _self._colorFilterPreviewImages : colorFilterPreviewImages // ignore: cast_nullable_to_non_nullable
as List<ColorFilterPreview>,adaptivePresets: null == adaptivePresets ? _self._adaptivePresets : adaptivePresets // ignore: cast_nullable_to_non_nullable
as List<String>,isInitialized: null == isInitialized ? _self.isInitialized : isInitialized // ignore: cast_nullable_to_non_nullable
as bool,initialImage: freezed == initialImage ? _self.initialImage : initialImage // ignore: cast_nullable_to_non_nullable
as Uint8List?,editedImage: freezed == editedImage ? _self.editedImage : editedImage // ignore: cast_nullable_to_non_nullable
as Uint8List?,cropOffset: null == cropOffset ? _self.cropOffset : cropOffset // ignore: cast_nullable_to_non_nullable
...
mixin _$ColorFilterPreview {
 ...
 String get name; Uint8List? get image;
/// Create a copy of ColorFilterPreview
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ColorFilterPreviewCopyWith<ColorFilterPreview> get copyWith => _$ColorFilterPreviewCopyWithImpl<ColorFilterPreview>(this as ColorFilterPreview, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ColorFilterPreview&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.image, image));
}


@override
int get hashCode => Object.hash(runtimeType,name,const DeepCollectionEquality().hash(image));
...
abstract mixin class $ColorFilterPreviewCopyWith<$Res>  {
  factory $ColorFilterPreviewCopyWith(ColorFilterPreview value, $Res Function(ColorFilterPreview) _then) = _$ColorFilterPreviewCopyWithImpl;
@useResult
$Res call({
 String name, Uint8List? image
});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$ColorFilterPreviewCopyWith<_ColorFilterPreview> get copyWith => __$ColorFilterPreviewCopyWithImpl<_ColorFilterPreview>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ColorFilterPreview&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.image, image));
}
...
/// @nodoc
abstract mixin class _$ColorFilterPreviewCopyWith<$Res> implements $ColorFilterPreviewCopyWith<$Res> {
  factory _$ColorFilterPreviewCopyWith(_ColorFilterPreview value, $Res Function(_ColorFilterPreview) _then) = __$ColorFilterPreviewCopyWithImpl;
@override @useResult
$Res call({
 String name, Uint8List? image
});
...
mixin _$EditedEmojiData {
 ...
 MisskeyEmojiData get emoji; double get scale; Offset get position; double get angle;
/// Create a copy of EditedEmojiData
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$EditedEmojiDataCopyWith<EditedEmojiData> get copyWith => _$EditedEmojiDataCopyWithImpl<EditedEmojiData>(this as EditedEmojiData, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EditedEmojiData&&(identical(other.emoji, emoji) || other.emoji == emoji)&&(identical(other.scale, scale) || other.scale == scale)&&(identical(other.position, position) || other.position == position)&&(identical(other.angle, angle) || other.angle == angle));
}
...
abstract mixin class $EditedEmojiDataCopyWith<$Res>  {
  factory $EditedEmojiDataCopyWith(EditedEmojiData value, $Res Function(EditedEmojiData) _then) = _$EditedEmojiDataCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of EditedEmojiData
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? emoji = null,Object? scale = null,Object? position = null,Object? angle = null,}) {
  return _then(_self.copyWith(
emoji: null == emoji ? _self.emoji : emoji // ignore: cast_nullable_to_non_nullable
as MisskeyEmojiData,scale: null == scale ? _self.scale : scale // ignore: cast_nullable_to_non_nullable
as double,position: null == position ? _self.position : position // ignore: cast_nullable_to_non_nullable
as Offset,angle: null == angle ? _self.angle : angle // ignore: cast_nullable_to_non_nullable
as double,
  ));
}
...
class _EditedEmojiData implements EditedEmojiData {
  const _EditedEmojiData({required this.emoji, required this.scale, required this.position, required this.angle});
  

@override final  MisskeyEmojiData emoji;
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$EditedEmojiDataCopyWith<_EditedEmojiData> get copyWith => __$EditedEmojiDataCopyWithImpl<_EditedEmojiData>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EditedEmojiData&&(identical(other.emoji, emoji) || other.emoji == emoji)&&(identical(other.scale, scale) || other.scale == scale)&&(identical(other.position, position) || other.position == position)&&(identical(other.angle, angle) || other.angle == angle));
}
...
/// @nodoc
abstract mixin class _$EditedEmojiDataCopyWith<$Res> implements $EditedEmojiDataCopyWith<$Res> {
  factory _$EditedEmojiDataCopyWith(_EditedEmojiData value, $Res Function(_EditedEmojiData) _then) = __$EditedEmojiDataCopyWithImpl;
@override @useResult
$Res call({
 MisskeyEmojiData emoji, double scale, Offset position, double angle
});
...
/// Create a copy of EditedEmojiData
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? emoji = null,Object? scale = null,Object? position = null,Object? angle = null,}) {
