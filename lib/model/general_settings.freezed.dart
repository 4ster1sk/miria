...
mixin _$GeneralSettings {
 ...
 double get textScaleFactor;/// 使用するUnicodeの絵文字種別
 ...
 String get fantasyFontName; bool get reactionSearchAutofocus;/// 言語設定
...
@useResult
$Res call({
 String lightColorThemeId, String darkColorThemeId, ThemeColorSystem themeColorSystem, NSFWInherit nsfwInherit, bool enableDirectReaction, AutomaticPush automaticPush, bool enableAnimatedMFM, bool enableLongTextElipsed, bool enableFavoritedRenoteElipsed, TabPosition tabPosition, double textScaleFactor, EmojiType emojiType, String defaultFontName, String serifFontName, String monospaceFontName, String cursiveFontName, String fantasyFontName, bool reactionSearchAutofocus, Languages languages, bool isDeckMode,@ColorConverter() Color? lightNoteBackgroundPublic,@ColorConverter() Color? lightNoteBackgroundHome,@ColorConverter() Color? lightNoteBackgroundFollowers,@ColorConverter() Color? lightNoteBackgroundDirect,@ColorConverter() Color? darkNoteBackgroundPublic,@ColorConverter() Color? darkNoteBackgroundHome,@ColorConverter() Color? darkNoteBackgroundFollowers,@ColorConverter() Color? darkNoteBackgroundDirect
});
...
as String,reactionSearchAutofocus: null == reactionSearchAutofocus ? _self.reactionSearchAutofocus : reactionSearchAutofocus // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey() final  bool reactionSearchAutofocus;
/// 言語設定
